...
import { FiHome, FiUser, FiSettings, FiLogOut, FiMenu, FiHeadphones } from "react-icons/fi";
        ...
        <ul className={styles.navList}>
          ...
          <li>
            <NavLink
              ...
              onClick={() => window.innerWidth < 768 && setIsOpen(false)}
            >
              <FiHeadphones className={styles.icon} size={20} />
              <span className={styles.navText}>Req. Suporte</span>
            </NavLink>
          </li>
          <li>
            <NavLink
